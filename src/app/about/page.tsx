      ...
      <div className="flex flex-col gap-3">
        ...
        <FramerWrapper y={0} x={100} >
          <p className=" font-poppins text-xl w-full text-primary max-sm:text-lg">
            I am a Full Stack Web Developer from Mirzapur, Uttar Pradesh,
            India. I love crafting cool web projects. My biggest achievement lies in my mastery of
            React, JavaScript and CSS, ensuring pixel-perfect designs that captivate
